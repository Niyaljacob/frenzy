    ...
    return Scaffold(
      ...
      body: BlocConsumer<AddpostBloc, AddpostState>(
        ...
        builder: (context, state) {
          bool isLoading = state is AddPostLoadingstate;
              ...
              child: Form(
                ...
                child: Column(
                  children: [
                        ...
                        return GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: imagePick.value == ''
                                ...
                                : Image.file(File(imagePick.value), fit: BoxFit.cover),
                          ),
                        );
                      },
                    ),
                        ...
                        : CustomButton(
                            ...
                            onPressed: () {
                              if (_formKey.currentState!.validate()) {
                                if (imagePick.value != '' && textController.text.isNotEmpty) {
                    ...
                    kheight,
                    Image.asset(
                      Theme.of(context).brightness == Brightness.light ? singupdark : singuplight,
                      height: 30,
                    ),
                  ],
                ),
